...
//                    .build();
            ...
            redirectAttributes.addFlashAttribute("notifications", List.of(
                    new Notification("The category has been saved successfully!", "success", "Category", LocalDateTime.now())
            ));
        } catch (Exception e) {
            redirectAttributes.addFlashAttribute("notifications", List.of(
                    new Notification("Error saving the category. Please try again later!", "danger", "Category", LocalDateTime.now()))
            );
        }
